...
if __name__ == '__main__':
    ...
    # 将结果转换为 DataFrame
        ...
        results_df = pd.DataFrame(results,
                                  columns=['代码', '名称', '收盘价', '开始时间', '结束时间', '持续天数', '市盈率',
                                           '市净率',
                                           '总市值', '涨跌幅', '5日涨跌幅', '10日涨跌幅', '20日涨跌幅', '30日涨跌幅',
                                           '60日涨跌幅', '年初至今涨跌幅', '上涨天数', '下跌天数', '涨幅天数比率'])
    # 将结果写入 CSV 文件
    results_df.to_csv('D:/abu/hk/all/results_monitor_20241204.csv', index=False, encoding='utf-8-sig')
