...
if __name__ == '__main__':
    ...
    current_data_path = 'D:/abu/cn/all/20241024.csv'
    ...
    # 将结果写入 CSV 文件
    results_df.to_csv('D:/abu/cn/all/results_monitor.csv', index=False, encoding='utf-8-sig')

    print("execute cost time {}".format(time.time() - start))

    # file_path = 'D:/abu/cn/stock/000001_20230101_20241024'
    # stock_code = file_path.split('/')[-1].split('_')[0]
    # current_df = pd.read_csv('D:/abu/cn/all/20241024.csv', dtype={'代码': str})
