...
# def get_stock_data_by_name(symbol, start_date='20230410', end_date='20240522'):
...
def get_all_us_stock_data():
    """
        获取所有股票的数据
    """
    stock_data = pd.read_csv('20240424')
    # 循环获取
    for i in stock_data['代码']:
        # 开头是8的股票代码，不处理
        # code = f"{i:06}"
...
def get_us_stock_data_by_name(symbol, start_date='20230410', end_date='20240524'):
